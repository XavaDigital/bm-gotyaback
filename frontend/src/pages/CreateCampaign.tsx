  ...
  const handleSubmit = async () => {
    try {
      ...
      if (
        ...
        await campaignService.createLayout(
          campaign._id,
          layoutData as CreateLayoutRequest
        );
      }
    ...
    },
    {
      ...
      content: (
        <Form
          form={form}
          layout="vertical"
          initialValues={{ campaignType: campaignData.campaignType }}
        >
          <Form.Item
            label="Campaign Type"
            name="campaignType"
          ...
          {campaignData.campaignType === "placement" && (
            <>
              ...
              <Form.Item
                ...
                rules={[
                  { required: true, message: "Please enter top zone price" },
                ]}
              >
                <InputNumber
                  min={1}
              ...
              <Form.Item
                ...
                rules={[
                  { required: true, message: "Please enter middle zone price" },
                ]}
              >
                <InputNumber
                  min={1}
              ...
              <Form.Item
                ...
                rules={[
                  { required: true, message: "Please enter bottom zone price" },
                ]}
              >
                <InputNumber
                  min={1}
