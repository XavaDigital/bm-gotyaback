...
router.get('/campaigns/:id/public-sponsors', sponsorshipController.getPublicSponsors);

// Protected routes (campaign owner only)
router.get('/campaigns/:id/sponsors', protect, sponsorshipController.getSponsors);
router.post('/sponsorships/:sponsorshipId/mark-paid', protect, sponsorshipController.markAsPaid);
